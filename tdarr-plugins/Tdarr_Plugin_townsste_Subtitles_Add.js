...
const details = () => ({
  id: "Tdarr_Plugin_townsste_Subtitles_Add",
  Stage: "Pre-processing",
  Name: "Add subtitles to MKV files",
  Type: "Subtitle",
  Operation: 'Transcode',
  Description: `This plugin will add srt and vobsub (.sub & .idx) files to an mkv file.\\n
	...
	This will also rename the subtitle file to merge.subtitle.  To remove the subtitles that are in your media directory 
	along side the video file you need to run townsste_Subtitles_Cleanup.\\n`,
  Version: "1.0",
