    ...
    try {
      ...
      if (
        ...
        && (file.ffProbeData.streams[i].tags.title
          ...
          || file.ffProbeData.streams[i].tags.title
            .toLowerCase()
            .includes('description') || file.ffProbeData.streams[i].disposition.comment == 1)
      ) {
        ffmpegCommandInsert += `-map -0:s:${subtitleIdx} `;
