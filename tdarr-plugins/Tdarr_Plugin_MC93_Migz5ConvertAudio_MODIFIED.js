...
const plugin = (file, librarySettings, inputs, otherArguments) => {
  ...
  let convert = false;
  let checkLang8 = false;
  let checkLang6 = false;
      ...
      try {
        ...
        if (inputs.downmix.toLowerCase() === 'true') {
          ...
          if (
            ...
            convert = true;
			if (file.ffProbeData.streams[i].tags.language === "eng"){
				checkLang8 = true;
			  }
          }
